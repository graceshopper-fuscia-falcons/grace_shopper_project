...
async function seed() {
  ...
  const fieldsOfEurope = await Plant.create({
    ...
    price: 4999,
    stock: 40,
    imageUrl: 'https://cdn2.1800flowers.com/wcsstore/Flowers/images/catalog/148245xlx.jpg',
    imageUrlsecondary: 'https://cdn2.1800flowers.com/wcsstore/Flowers/images/catalog/148245alt_viewx.jpg',
  ...
  const deliciouslyDecadent = await Plant.create({
    ...
    price: 8999,
    stock: 40,
    imageUrl: 'https://cdn4.fruitbouquets.com/wcsstore/Flowers/images/catalog/192961sbmdsv1x.jpg',
    imageUrlsecondary: 'https://cdn4.fruitbouquets.com/wcsstore/Flowers/images/catalog/192961alt_view1x.jpg',
  ...
  const autumnConfetti = await Plant.create({
    ...
    price: 4999,
    stock: 40,
    imageUrl: 'https://cdn3.1800flowers.com/wcsstore/Flowers/images/catalog/176881lx.jpg',
    imageUrlsecondary: 'https://cdn3.1800flowers.com/wcsstore/Flowers/images/catalog/176881alt_view1x.jpg',
  ...
  const doggieHowser = await Plant.create({
    ...
    price: 4999,
    stock: 40,
    imageUrl: 'https://cdn2.1800flowers.com/wcsstore/Flowers/images/catalog/146761x.jpg',
    imageUrlsecondary: 'https://cdn2.1800flowers.com/wcsstore/Flowers/images/catalog/146761alt_viewx.jpg',
  ...
  const floralEmbrace = await Plant.create({
    ...
    price: 4999,
    stock: 40,
    imageUrl: 'https://cdn3.1800flowers.com/wcsstore/Flowers/images/catalog/167891lx.jpg',
    imageUrlsecondary: 'https://cdn3.1800flowers.com/wcsstore/Flowers/images/catalog/148522alt_viewx.jpg',
  ...
  const goodDay = await Plant.create({
    ...
    price: 4499,
    stock: 40,
    imageUrl: 'https://cdn1.1800flowers.com/wcsstore/Flowers/images/catalog/179057x.jpg',
    imageUrlsecondary: 'https://cdn1.1800flowers.com/wcsstore/Flowers/images/catalog/179057alt_viewx.jpg',
  ...
  const cureAllKitty = await Plant.create({
    ...
    price: 6499,
    stock: 40,
    imageUrl: 'https://cdn3.1800flowers.com/wcsstore/Flowers/images/catalog/167683bx.jpg',
    imageUrlsecondary: 'https://cdn3.1800flowers.com/wcsstore/Flowers/images/catalog/167683alt_viewx.jpg',
  ...
  const hangInThere = await Plant.create({
    ...
    price: 4499,
    stock: 40,
    imageUrl: 'https://cdn2.1800flowers.com/wcsstore/Flowers/images/catalog/101735lckx.jpg',
    imageUrlsecondary: 'https://cdn2.1800flowers.com/wcsstore/Flowers/images/catalog/101735alt_viewx.jpg',
  ...
  const warmSunset = await Plant.create({
    ...
    price: 3999,
    stock: 40,
    imageUrl: 'https://cdn1.1800flowers.com/wcsstore/Flowers/images/catalog/100589swkv1sfh2x.jpg',
    imageUrlsecondary: 'https://cdn1.1800flowers.com/wcsstore/Flowers/images/catalog/87827_altviewx.jpg',
  ...
  const cherishedMemories = await Plant.create({
    ...
    price: 7999,
    stock: 40,
    imageUrl: 'https://cdn3.1800flowers.com/wcsstore/Flowers/images/catalog/95379lx.jpg',
    imageUrlsecondary: 'https://cdn3.1800flowers.com/wcsstore/Flowers/images/catalog/95379alt_viewx.jpg',
  ...
  const healingTears = await Plant.create({
    ...
    price: 4999,
    stock: 40,
    imageUrl: 'https://cdn1.1800flowers.com/wcsstore/Flowers/images/catalog/148683lx.jpg',
    imageUrlsecondary: 'https://cdn1.1800flowers.com/wcsstore/Flowers/images/catalog/148683alt_viewx.jpg',
  ...
  const lovingSentiments = await Plant.create({
    ...
    price: 4999,
    stock: 40,
    imageUrl: 'https://cdn2.1800flowers.com/wcsstore/Flowers/images/catalog/167006lx.jpg',
    imageUrlsecondary: 'https://cdn2.1800flowers.com/wcsstore/Flowers/images/catalog/167006alt_viewx.jpg',
  ...
  const sincerestSorrow = await Plant.create({
    ...
    price: 10999,
    stock: 40,
    imageUrl: 'https://cdn1.1800flowers.com/wcsstore/Flowers/images/catalog/148693lx.jpg',
    imageUrlsecondary: 'https://cdn1.1800flowers.com/wcsstore/Flowers/images/catalog/148693alt_viewx.jpg',
  ...
  const whiteBouquetForSympathy = await Plant.create({
    ...
    price: 5999,
    stock: 40,
    imageUrl: 'https://cdn2.1800flowers.com/wcsstore/Flowers/images/catalog/147703ssmv3x.jpg',
    imageUrlsecondary: 'https://cdn2.1800flowers.com/wcsstore/Flowers/images/catalog/95043alt_view1x.jpg',
  ...
  const beautifulBlooms = await Plant.create({
    ...
    price: 5499,
    stock: 40,
    imageUrl: 'https://cdn3.1800flowers.com/wcsstore/Flowers/images/catalog/159132sv2sc2120418x.jpg',
    imageUrlsecondary: 'https://cdn3.1800flowers.com/wcsstore/Flowers/images/catalog/84208_hg_sc2_suncatcherx.jpg',
  ...
  const cherishedGarden = await Plant.create({
    ...
    price: 4999,
    stock: 40,
    imageUrl: 'https://cdn3.1800flowers.com/wcsstore/Flowers/images/catalog/179097lx.jpg',
    imageUrlsecondary: 'https://cdn3.1800flowers.com/wcsstore/Flowers/images/catalog/156138alt_viewx.jpg',
  ...
  const buddingRose = await Plant.create({
    ...
    price: 6799,
    stock: 40,
    imageUrl: 'https://cdn2.1800flowers.com/wcsstore/Flowers/images/catalog/101980lyspx.jpg',
    imageUrlsecondary: 'https://cdn2.1800flowers.com/wcsstore/Flowers/images/catalog/rosealt_viewx.jpg',
  ...
  const pickOfThePatch = await Plant.create({
    ...
    price: 6799,
    stock: 40,
    imageUrl: 'https://cdn3.1800flowers.com/wcsstore/Flowers/images/catalog/158154lx.jpg',
    imageUrlsecondary: 'https://cdn3.1800flowers.com/wcsstore/Flowers/images/catalog/158154alt_view3x.jpg',
  ...
  const gatherTogether = await Plant.create({
    ...
    price: 5499,
    stock: 40,
    imageUrl: 'https://cdn3.1800flowers.com/wcsstore/Flowers/images/catalog/158158lkx.jpg',
    imageUrlsecondary: 'https://cdn3.1800flowers.com/wcsstore/Flowers/images/catalog/158158alt_view2x.jpg',
  ...
  const bloomDish = await Plant.create({
    ...
    price: 4999,
    stock: 40,
    imageUrl: 'https://cdn2.1800flowers.com/wcsstore/Flowers/images/catalog/18650hbdx.jpg',
    imageUrlsecondary: 'https://cdn2.1800flowers.com/wcsstore/Flowers/images/catalog/18650alt_view1x.jpg',
  ...
  const azaleaBonsai = await Plant.create({
    ...
    price: 4499,
    stock: 40,
    imageUrl: 'https://cdn2.1800flowers.com/wcsstore/Flowers/images/catalog/18201lwx.jpg',
    imageUrlsecondary: 'https://cdn2.1800flowers.com/wcsstore/Flowers/images/catalog/18201alt_view2x.jpg',
  ...
  const sophisticatedLily = await Plant.create({
    ...
    price: 4699,
    stock: 40,
    imageUrl: 'https://cdn2.1800flowers.com/wcsstore/Flowers/images/catalog/101199lx.jpg',
    imageUrlsecondary: 'https://cdn2.1800flowers.com/wcsstore/Flowers/images/catalog/101198_calla_lily_1_altx.jpg',
  ...
  const sweetHeartBamboo = await Plant.create({
    ...
    price: 3999,
    stock: 40,
    imageUrl: 'https://cdn1.1800flowers.com/wcsstore/Flowers/images/catalog/18999ln2x.jpg',
    imageUrlsecondary: 'https://cdn1.1800flowers.com/wcsstore/Flowers/images/catalog/18999alt_viewx.jpg',
  ...
  const grandGardenia = await Plant.create({
    ...
    price: 4699,
    stock: 40,
    imageUrl: 'https://cdn2.1800flowers.com/wcsstore/Flowers/images/catalog/18053xlcx.jpg',
    imageUrlsecondary: 'https://cdn2.1800flowers.com/wcsstore/Flowers/images/catalog/gardeniaalt_viewx.jpg',
  ...
  const bonfireWarmthOrchid = await Plant.create({
    ...
    price: 9499,
    stock: 40,
    imageUrl: 'https://cdn1.1800flowers.com/wcsstore/Flowers/images/catalog/157982l4x.jpg',
    imageUrlsecondary: 'https://cdn1.1800flowers.com/wcsstore/Flowers/images/catalog/157982alt_1x.jpg',
  ...
  const herbGardenTrio = await Plant.create({
    ...
    price: 3999,
    stock: 40,
    imageUrl: 'https://cdn1.1800flowers.com/wcsstore/Flowers/images/catalog/157209lnx.jpg',
    imageUrlsecondary: 'https://cdn1.1800flowers.com/wcsstore/Flowers/images/catalog/157209alt_viewx.jpg',
  ...
  const elegantCallaLily = await Plant.create({
    ...
    price: 4499,
    stock: 40,
    imageUrl: 'https://cdn1.1800flowers.com/wcsstore/Flowers/images/catalog/18747kpskx.jpg',
    imageUrlsecondary: 'https://cdn1.1800flowers.com/wcsstore/Flowers/images/catalog/18747alt_view2x.jpg',
  ...
  const cactusDishGarden = await Plant.create({
    ...
    price: 5499,
    stock: 40,
    imageUrl: 'https://cdn1.1800flowers.com/wcsstore/Flowers/images/catalog/1830lx.jpg',
    imageUrlsecondary: 'https://cdn1.1800flowers.com/wcsstore/Flowers/images/catalog/supplied_alt_2_stushigalstylex.jpg',
  ...
  const birdsOfParadise = await Plant.create({
    ...
    price: 9999,
    stock: 40,
    imageUrl: 'https://cdn1.1800flowers.com/wcsstore/Flowers/images/catalog/158107llx.jpg',
    imageUrlsecondary: 'https://cdn1.1800flowers.com/wcsstore/Flowers/images/catalog/158107alt_view1x.jpg',
  ...
  const snakeFloor = await Plant.create({
    ...
    price: 8999,
    stock: 40,
    imageUrl: 'https://cdn1.1800flowers.com/wcsstore/Flowers/images/catalog/157624lgx.jpg',
    imageUrlsecondary: 'https://cdn1.1800flowers.com/wcsstore/Flowers/images/catalog/157624alt_view_lx.jpg',
  ...
  const ultimateElegance = await Plant.create({
    ...
    price: 12999,
    stock: 40,
    imageUrl: 'https://cdn3.1800flowers.com/wcsstore/Flowers/images/catalog/161777l010918x.jpg',
    imageUrlsecondary: 'https://cdn3.1800flowers.com/wcsstore/Flowers/images/catalog/redroses_altx.jpg',
  ...
  const lovePup = await Plant.create({
    ...
    price: 5999,
    stock: 40,
    imageUrl: 'https://cdn3.1800flowers.com/wcsstore/Flowers/images/catalog/179409x.jpg',
    imageUrlsecondary: 'https://cdn3.1800flowers.com/wcsstore/Flowers/images/catalog/179409alt_viewx.jpg',
  ...
  const eveningAutumn = await Plant.create({
    name: 'Evening Autumn™',
    flowerColor: 'yellow',
    flowerType: 'get-well',
    price: 4999,
    stock: 40,
    imageUrl: 'https://cdn2.1800flowers.com/wcsstore/Flowers/images/catalog/183645lx.jpg',
    imageUrlsecondary: 'https://cdn2.1800flowers.com/wcsstore/Flowers/images/catalog/183645alt_viewx.jpg',
    description: "Like the warm glow of an autumn evening, our new arrangement is full of vibrant beauty. A gathering of orange roses and bronze daisy poms are set against unique purple kale, capturing the color of the sky just before the sun goes down. Artfully arranged in our textured fabric hatbox, with simple, natural style to really let each bloom pop."
  })
